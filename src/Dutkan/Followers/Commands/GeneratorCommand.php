...
use Dutkan\Followers\Filesystem\FileAlreadyExists;
use Dutkan\Followers\Generator;
use Config;

abstract class GeneratorCommand extends Command {

    /**
     * @var \Dutkan\Followers\ModelGenerator
     */
    protected $generator;
    ...
    protected function getPathByOptionOrConfig($option, $configName)
    {
        ...
        return Config::get("followers::config.{$configName}");
    }
    ...
    {
        return array (
            array('path', null, InputOption::VALUE_REQUIRED, 'Where should the file be created?'),
            array('templatePath', null, InputOption::VALUE_REQUIRED, 'The location of the template for this generator'),
        );
    }
